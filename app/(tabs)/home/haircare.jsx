...
const haircareFilters = [
  ...
  { label: 'Shampoo', value: 'shampoo', count: 6 },
  { label: 'Conditioner', value: 'conditioner', count: 6 },
  { label: 'Dry Shampoo', value: 'dry-shampoo', count: 6 },
          ...
          {activeFilter !== 'all' && (
            <View style={styles.activeFilterContainer}>
              <Text style={styles.activeFilterText}>
                {haircareFilters.find(f => f.value === activeFilter)?.label}
              </Text>
            </View>
          )}
        </View>
